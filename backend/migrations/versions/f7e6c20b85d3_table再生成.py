...
Revision ID: f7e6c20b85d3
Revises: 
Create Date: 2026-02-22 23:38:18.128307
...
def upgrade() -> None:
    ...
    op.execute("""
        INSERT INTO feedbacks (id, attempt_id, avatar_id, good_points, improve_points, next_tip)
        VALUES
        (1, 1, 1, 'ハキハキ喋れてます！', '志望動機が他社でも成立するないようになってしまっています。', '志望がその企業ではなければダメだとわかる内容にしましょう！'),
        (2, 2, 3, '基本的に大きな問題はありません。', 'もう少し定量的な表現を入れるとgoodです。', '定量的な表現にしましょう。')
    """)
